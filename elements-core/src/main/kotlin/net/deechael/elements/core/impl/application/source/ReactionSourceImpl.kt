...
class ReactionSourceImpl(private val reaction: ElementReaction, elementType: ElementType, gauge: ElementGauge) :
    ApplicationSourceImpl(elementType, gauge), ReactionSource {
