...
class ElementTypeImpl(private val id: String, private val color: Color, private val applicable: Boolean, private val reactable: Boolean, private val isReactionElement: Boolean, private val trigger: ApplicationTrigger) : ElementType {
